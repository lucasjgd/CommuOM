        ...
        <table class="styled-table">
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($userResult)): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($row['pseudo']); ?></td> <!-- Display username / Afficher le pseudo -->
                        <td><?php echo htmlspecialchars($row['mail']); ?></td> <!-- Display email / Afficher l'email -->
                        <td><?php echo ($row['role'] == 1 ? 'Admin' : 'Utilisateur'); ?></td> <!-- Display role / Afficher le rôle -->
                        <td>
